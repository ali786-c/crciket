...
<?php $component->withAttributes([]); ?>
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" class="vstack gap-3">
        <?php echo csrf_field(); ?>
        <div>
            <label for="name" class="form-label">Name</label>
            <input id="name" name="name" type="text" value="<?php echo e(old('name')); ?>" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 pt-2">
            <a href="<?php echo e(route('login')); ?>" class="small text-success">Already registered?</a>
...
<?php endif; ?>
<?php /**PATH C:\Users\Muhammad Aliyan\Downloads\cricket-draft-source\resources\views/auth/register.blade.php ENDPATH**/ ?>